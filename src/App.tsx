...
function App() {
   ...
   function changeFilter(value: FilterValuesType) {
    ...
    const ChangeboxEdit=(id:string)=>{
        let tasksForChangebox=tasks
        tasksForChangebox=tasks.map(el=>el.id===id? {...el,isDone:!el.isDone}:el)
        setTasks(tasksForChangebox)
